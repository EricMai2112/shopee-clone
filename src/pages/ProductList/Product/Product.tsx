...
import { formartNumberToSocialStyle, formatCurrency } from 'src/utils/utils'
        ...
        <div className='p-2 overflow-hidden'>
          ...
          <div className='flex items-center mt-3'>
            <div className='line-through max-w-[50%] text-gray-500 truncate'>
              ...
              <span className='text-sx'>{product.price_before_discount}</span>
            </div>
            <div className='text-[#ee4d2d] truncate ml-1'>
              <span className='text-sx'>₫</span>
              <span className='text-sx'>{formatCurrency(product.price)}</span>
            </div>
          </div>
